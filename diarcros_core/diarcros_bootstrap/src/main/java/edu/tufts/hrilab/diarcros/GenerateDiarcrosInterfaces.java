 ...
 */
public class GenerateDiarcrosInterfaces {
  ...
  public GenerateDiarcrosInterfaces() {
  ...
  public static void main(String[] args) {
    ...
    GenerateDiarcrosInterfaces generateInterfaces = new GenerateDiarcrosInterfaces();
  ...
  private void writeInterface(MessageDeclaration messageDeclaration, File outputDirectory,
    ...
    MessageDiarcrosInterfaceBuilder builder = new MessageDiarcrosInterfaceBuilder();
